...
\usepackage[a4paper,left=1.5in,right=1in,top=1.2in,bottom=1in]{geometry}
\usepackage{fontspec}
\usepackage{ucharclasses}
\setmainfont{Times New Roman}
\setsansfont{Angsana New}
\setmonofont{Courier New}
\newfontfamily\thaifont{Angsana New}
...
\setlist[itemize]{leftmargin=0.65in,itemsep=0.1em,topsep=0.2em}
\titleformat{\chapter}[display]{\normalfont\bfseries\centering}{CHAPTER \thechapter}{0.5em}{\MakeUppercase}
...
\end{figure}
{\MakeUppercase{AI-POWERED FILE ORGANIZER APPLICATION}\par}
\vspace{2in}
{SARUN KHUMTHAI}\par
{SUPAKORN TUNGPATOMPRAMOTE}\par
{PUWADECH INTONG}\par
\vfill
{A PROJECT SUBMITTED IN PARTIAL FULFILLMENT\par}
{OF THE REQUIREMENTS FOR\par}
{THE DEGREE OF BACHELOR OF ENGINEERING (COMPUTER ENGINEERING)\par}
...
\begin{center}
\vspace{0.2in}
AI-powered file organizer application\\[1in]
Mr. Sarun Khumthai\\[0.08in]
Mr. Supakorn Tungpatompramote\\[0.08in]
Mr. Puwadech Intong\\[0.08in]
\vspace{1in}
...
% Committee signatures: use a consistent two-column table for alignment
\begin{tabular}{@{}p{0.62\textwidth}p{0.36\textwidth}@{}}
\dotfill & Project Advisor \\
\multicolumn{1}{@{}p{0.62\textwidth}@{}}{\centering (Suthathip Maneewongvatana, Ph.D.)} & \\
\\[0.2in]
\dotfill & Committee Member \\
\multicolumn{1}{@{}p{0.62\textwidth}@{}}{\centering (Name, Title)} & \\
\\[0.2in]
\dotfill & Committee Member \\
\multicolumn{1}{@{}p{0.62\textwidth}@{}}{\centering (Name, Title)} & \\
\\[0.2in]
...
\begin{flushleft}
\begin{tabular*}{\textwidth}{@{}lp{0.8\textwidth}}
\textbf{คำสำคัญ}: & แอปพลิเคชันจัดระเบียบไฟล์อย่างอัตโนมัติด้วย AI / การจัดการไฟล์ / การจำแนกเอกสาร / Local LLM / RAG
\end{tabular*}
\end{flushleft}
}
...
\begin{itemize}
\item means unable to solve the problem.
...
\toprule
{[1]} & Information for AI\newline \url{https://aws.amazon.com/th/what-is/nlp/}\newline \url{https://aws.amazon.com/th/what-is/large-language-model/}\newline \url{https://www.nvidia.com/en-us/glossary/vision-language-models/}\newline \url{https://aws.amazon.com/th/what-is/retrieval-augmented-generation/} \\
\midrule
{[2]} & LLM \& VLM market\newline \url{https://ollama.com/}\newline \url{https://huggingface.co/} \\
{[3]} & RAG anything\newline \url{https://arxiv.org/abs/2510.12323}\newline \url{https://github.com/HKUDS/RAG-Anything} \\
{[4]} & LightRAG\newline \url{https://github.com/HKUDS/LightRAG} \\
{[5]} & Python computer language\newline \url{https://www.python.org/doc/} \\
{[6]} & Rust computer language\newline \url{https://web.mit.edu/rust-lang_v1.25/arch/amd64_ubuntu1404/share/doc/rust/html/book/first-edition/documentation.html} \\
{[7]} & Tuari framework\newline \url{https://v2.tauri.app/start/} \\
{[8]} & Semantic File System paper\newline \url{https://pages.cs.wisc.edu/~remzi/Classes/838/Fall2001/Papers/sfs-sosp91.pdf?utm_source=chatgpt.com} \\
{[9]} & Auto Organizer: A Machine Learning-Based Tool for Automatic Organization of          Files\newline \url{https://www.researchgate.net/publication/371930502_Auto_Organizer_A_Machine_Learning-Based_Tool_for_Automatic_Organization_of_Files} \\
{[10]} & Llama.ccp\newline \url{https://github.com/ggml-org/llama.cpp} \\
\bottomrule
\end{longtable}

\appendix
\chapter{Experts' form}
\end{document}
