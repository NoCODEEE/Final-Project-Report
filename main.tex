...
\subsection*{The Evaluation tool used to evaluate the application was a performance evaluation form, divided into two sections:}
...
\addcontentsline{toc}{section}{App Installation Guide}
